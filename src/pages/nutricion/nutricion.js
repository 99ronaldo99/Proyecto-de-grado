...
var NutricionPage = /** @class */ (function () {
    function NutricionPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    NutricionPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad NutricionPage');
    };
    NutricionPage.prototype.openTabs = function () {
        this.navCtrl.setRoot(HomePage);
    };
    NutricionPage = __decorate([
        IonicPage(),
        Component({
